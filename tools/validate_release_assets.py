"""Static release-asset validation for the Conditional DETR ResNet-50 object-detection DIMER pipeline.
...
EXPECTED_MODEL_ID = "microsoft/conditional-detr-resnet-50"
...
EXPECTED_OUTPUTS = (
    "conditional_detr_detection_input_manifest.json",
    "conditional_detr_detection_evaluation_report.json",
    "conditional_detr_detection_result.json",
    "conditional_detr_detection_detections.csv",
    "conditional_detr_detection_annotated.png",
    "conditional_detr_adapter.safetensors",
)
...
MARKDOWN_MARKERS = (
    ...
    "sigmoid under the model's focal-loss head, not a calibrated",
...
EXTERNAL_WEIGHT_BYTES: dict[int, str] = {
    174290209: "upstream pytorch_model.bin (pickle checkpoint at the same Hub revision; not staged, not loaded)",
}
