...
The upstream snapshot is pinned to `8f8795fb7c319c7862d4f4cd699e76bb09cf2593` and the notebook is regenerated with that revision and manifest, so it can run; no execution is recorded yet.
